/**
 * @file
 * Contains the WeatherIcons class.
 */

/**
 * Maps weather codes from the yahoo api to icon classes from the weather_icons library.
 *
 * Icon map adapted from https://github.com/mlaroy/weather-widget.
 *
 ...
 * Class weatherIcons.
 *
 * Helper to determine an icon class from a weather code.
 */
class WeatherIcons {

  static getIconClass(code) {
    const icon = this._getIcon(code);
  ...
  static _getIcon(code) {
    return icons.codes.find(icon => icon.number === code);
  }
